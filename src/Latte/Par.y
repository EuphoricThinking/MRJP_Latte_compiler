...
Program : ListTopDef { (fst $1, Latte.Abs.Prog (fst $1) (snd $1)) }
...
Arg
  : Type Ident { (fst $1, Latte.Abs.Ar (fst $1) (snd $1) (snd $2)) }
...
Block
  : '{' ListStmt '}' { (uncurry Latte.Abs.BNFC'Position (tokenLineCol $1), Latte.Abs.Blk (uncurry Latte.Abs.BNFC'Position (tokenLineCol $1)) (snd $2)) }
