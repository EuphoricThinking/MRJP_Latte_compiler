...
instance Print (Latte.Abs.Program' a) where
  prt i = \case
    Latte.Abs.Prog _ topdefs -> prPrec i 0 (concatD [prt 0 topdefs])
...
instance Print (Latte.Abs.ClassBody' a) where
  prt i = \case
    Latte.Abs.CBlock _ classstmts -> prPrec i 0 (concatD [doc (showString "{"), prt 0 classstmts, doc (showString "}")])

instance Print [Latte.Abs.ClassStmt' a] where
  prt _ [] = concatD []
  prt _ (x:xs) = concatD [prt 0 x, prt 0 xs]

instance Print (Latte.Abs.ClassStmt' a) where
  prt i = \case
    Latte.Abs.ClassEmpty _ -> prPrec i 0 (concatD [doc (showString ";")])
    Latte.Abs.ClassDecl _ type_ classitems -> prPrec i 0 (concatD [prt 0 type_, prt 0 classitems, doc (showString ";")])
    Latte.Abs.ClassMethod _ type_ id_ args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
...
instance Print (Latte.Abs.Block' a) where
  prt i = \case
    Latte.Abs.Blk _ stmts -> prPrec i 0 (concatD [doc (showString "{"), prt 0 stmts, doc (showString "}")])
...
instance Print (Latte.Abs.Stmt' a) where
  prt i = \case
    ...
    Latte.Abs.AssArr _ expr1 expr2 expr3 -> prPrec i 0 (concatD [prt 6 expr1, doc (showString "["), prt 0 expr2, doc (showString "]"), doc (showString "="), prt 0 expr3, doc (showString ";")])
    ...
    Latte.Abs.DecClass _ expr id_ -> prPrec i 0 (concatD [prt 6 expr, doc (showString "."), prt 0 id_, doc (showString "--"), doc (showString ";")])
    ...
    Latte.Abs.For _ type_ id_1 id_2 stmt -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 type_, prt 0 id_1, doc (showString ":"), prt 0 id_2, doc (showString ")"), prt 0 stmt])
...
instance Print (Latte.Abs.Expr' a) where
  prt i = \case
    ...
    Latte.Abs.EMethod _ expr id_ exprs -> prPrec i 6 (concatD [prt 6 expr, doc (showString "."), prt 0 id_, doc (showString "("), prt 0 exprs, doc (showString ")")])
